...
import FactoryScene    from '../components/FactoryScene.jsx';
import ControlPanel    from '../components/ControlPanel.jsx';
import AlertSystem     from '../components/AlertSystem.jsx';
import DashboardNavbar from '../components/DashboardNavbar.jsx';
import AnalyticsPanel  from '../components/AnalyticsPanel.jsx';
import { MACHINE_CONFIGS, generateTelemetry, onMachineUpdate } from '../store/machineStore.js';
...
export default function Dashboard() {
  ...
  /* ── Simulation engine — only runs after loading completes ── */
  useEffect(() => {
    if (!loaded) return;
